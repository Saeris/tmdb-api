...
import type { Gender } from "./getGender"
...
export class Person {
  ...
  constructor({
    ...
    const { backdrops = [], posters = [] } = taggedImages as unknown as Record<
      string,
      (Backdrop | Poster)[]
    >
    this.taggedImages = [
